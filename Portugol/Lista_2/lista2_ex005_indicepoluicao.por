programa
{
	 ...
	 */
		...
		se (indice>=0.05 e indice <=0.25)
		{
			...
			escreva("\nIndústrias do 1º, 2º e 3º grupo: AS ATIVIDADES PODEM CONTINUAR")
		}
		senao se (indice>0.3 e indice<=0.4)
		{
			escreva("\nIndústrias do 1º grupo devem parar")
		}
		senao se (indice>0.4 e indice<=0.5)
		{
			escreva("\nIndústrias do 1º e 2º grupo devem parar")
		}
		senao se (indice>0.5)
		{
			escreva("\nIndústrias do 1º, 2º e 3º grupo devem parar")

		}
		senao
		{
			escreva("\nSituação estável, sem notificação.")
		}
	}
}
/* $$$ Portugol Studio $$$ 
